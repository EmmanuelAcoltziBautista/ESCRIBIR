...
public class WEB extends JFrame implements ActionListener{
	...
	setTitle("FORMATO APA WEB");
	label1=new JLabel("PAGINAS WEB");
...
//FECHA DE RECUPERACION DEL DOCUMENTO
	...
	label5=new JLabel("FECHA DE RECUPERACION DEL DOCUMENTO");
	label5.setBounds(10,430,300,60);
	add(label5);
	
	TEXTO4=new JTextField();
	TEXTO4.setBounds(280,430,200,80);
	add(TEXTO4);

//ASOCIACION QUE PUBLICA EL ARTICULO

	label6=new JLabel("ASOCIACION QUE PUBLICA EL ARTICULO");
	label6.setBounds(10,530,300,60);
	add(label6);
...
//URL
	...
	label7=new JLabel("INGRESA LA URL");
...
public void actionPerformed(ActionEvent A){
	...
	String URL=TEXTO6.getText();
	String ASOCIACION=TEXTO5.getText();
	int PUBLICACION=Integer.parseInt(TEXTO2.getText());
	int RECUPERACION=Integer.parseInt(TEXTO4.getText());
	AREA1.setText(AUTOR+"."+" ("+PUBLICACION+"). "+TITULO+"."+" "+RECUPERACION+", DE "+ASOCIACION+" SITIO WEB: "+URL);
	}
