...
import java.awt.*;
public class PERIODICO extends JFrame implements ActionListener{
	...
	setTitle("FORMATO APA PERIODICO");
	label1=new JLabel("PERIODICO");
...
//TITULO DEL PERIODICO
	...
	label4=new JLabel("TITULO DEL PERIODICO");
...
//TITULO DEL ARTICULO
	...
	label5=new JLabel("INGRESA EL TITULO DEL ARTICULO");
...
//PAGINAS
	...
	label6=new JLabel("INGRESA LAS PAGINAS");
...
public void actionPerformed(ActionEvent A){
	...
	String TITULOPER=TEXTO3.getText();
	String TITULO=TEXTO4.getText();
	int PAG=Integer.parseInt(TEXTO5.getText());
	int ANO=Integer.parseInt(TEXTO2.getText());
	AREA1.setText(AUTOR+"."+" ("+ANO+"). "+TITULO+"."+" "+TITULOPER+", "+PAG+".");
	}
